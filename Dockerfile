...
RUN apt update -y -qq && apt install xinetd telnetd dialog musl screen ca-certificates wget language-pack-en less gcc g++ openssh-client -y -qq
...
RUN wget https://raw.githubusercontent.com/mevdschee/2048.c/master/2048.c -O /tmp/2048.c
RUN gcc -o /usr/bin/2048 /tmp/2048.c
RUN chmod +x /usr/bin/2048
